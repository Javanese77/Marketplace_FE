...
<body class="">
    ...
    <div class="h-screen flex items-center justify-center">
        <div class="back-login-form">
            ...
            <form action="/JB_Marketplace/routes/index.php?controller=User&action=create" method="post">
            <div class="relative mb-10 border-none">
                <input type="text" placeholder="Nama" class="place" name="nama" required/>
            </div>
            <div class="relative mb-10 border-none">
                <input type="text" placeholder="Username" class="place" name="uName" required/>
            </div>
            <div class="relative mb-10 border-none">
                <input type="email" placeholder="Email" class="place" name="email" required/>
            </div>
            <div class="relative mb-10 border-none">
                <input type="tel" placeholder="Nomor Handphone" class="place" name="no_hp" required/>
            </div>
            <div class="relative mb-10 border-none">
