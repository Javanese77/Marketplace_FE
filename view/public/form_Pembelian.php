            ...
            <div class="text-left ml-5">
                <h2 class="text-center font-sans text-3xl mt-5 font-bold">TWS</h2>
                    ...
                    <div class="mt-[200px]">
                        ...
                        <input type="number" value="jumlah" name="jumlah" id="jumlah" class="rounded-md text-center mt-5 w-[150px] h-[40px] outline-2 outline-offset-0 outline-black" min="0" max="100"><br><br>
                    ...
                    <div class="mt-15 mr-4">
                        <a href="/JB_Marketplace/routes/index.php?controller=User&action=alertLanjut"><input type="submit" value="buy" class="bg-green-500 text-center text-white w-full"></a>
                    </div>
                    <div class="mt-1 mr-4">
                        <a href=""><input type="submit" value="cancel" class="bg-red-500 text-center text-white w-full"></a>
                    </div>
                </div>
            </div>
        </div>
